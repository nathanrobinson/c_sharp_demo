...
namespace cs_tests
{
    ...
    public class object_struct_tests
    {
        ...
        public void Reference_equals_null()
        {
            ...
            Assert.IsTrue(object.ReferenceEquals(objectReference, null));
        ...
        public void Struct_not_equals_null()
        {
            ...
            Assert.IsFalse(object.ReferenceEquals(structValue, null));
        }
        ...
        public void New_reference_not_equals_null()
        {
            ...
            Assert.IsFalse(object.ReferenceEquals(objectReference, null));
        ...
        public void New_reference_equals_copy()
        {
            ...
            Assert.IsTrue(object.ReferenceEquals(objectReference, objectReference2));
        ...
        public void Struct_not_equals_copy()
        {
            ...
            Assert.IsFalse(object.ReferenceEquals(structValue, structValue2));
        }
